  ...
  return (
    <div className="space-y-8">
      <div>
              ...
              return (
                <Link to={`/course/${course._id}`} key={course._id} className="block bg-slate-800 rounded-lg shadow-md overflow-hidden transform hover:-translate-y-1 transition-transform">
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-slate-400 mt-2">Instructor: {course.teacher.name}</p>
                  </div>
                </Link>
              )
            })}
       ...
       <div className="mt-6">
         <Link to="/courses" className="inline-block px-6 py-3 font-semibold text-white bg-indigo-600 rounded-md hover:bg-indigo-700">
            Browse All Courses
          </Link>
      </div>
    </div>
